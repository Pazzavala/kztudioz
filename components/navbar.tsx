...
export default function Navbar() {
   ...
   return (
      <div className='relative z-[99]'>
         ...
         <motion.div
            className='fixed top-0 lg:top-[4.12rem] left-1/2 h-[4.5rem] lg:h-9 w-full lg:w-[33rem] rounded-none bg-gray-300/20 dark:bg-white/20 border-gray-400 border-opacity-20 shadow-lg shadow-black/10 backdrop-blur-md lg:rounded-full'
