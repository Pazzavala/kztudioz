...
export default function Navbar() {
   ...
   return (
      <div className='relative z-[999]'>
         ...
         <motion.div
            className='fixed top-0 lg:top-16 left-1/2 h-[5rem] w-full lg:h-10 lg:w-[33rem] rounded-none bg-gray-200 dark:bg-white bg-opacity-50 dark:bg-opacity-20 border border-gray-400 border-opacity-20 shadow-lg shadow-black/10 backdrop-blur-md lg:rounded-full'
               ...
               {navLinks.map((navLink, index) => (
                  ...
                  >
                     <Link
                        ...
                        className={clsx(
                           'flex w-full items-center p-2 justify-center text-gray-800 dark:text-white hover:text-blue-kz text-sm lg:text-base transition',
                           {
